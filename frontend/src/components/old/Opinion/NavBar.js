        ...
        <AppBar className={classes.appBar} position="static">
          <Toolbar className={classes.desktopBar} variant="dense">
            ...
            <IconButton className={classes.cartButton} size="medium">
              <Link to="/cart">
                <Badge badgeContent={items.length} color="secondary"></Badge>
              </Link>
            </IconButton>
            ...
            {authenticated ? (
              ...
              <div style={{ display: "flex" }}>
                <Link className={classes.linkDecoration} to="/login">
                  <Typography className={classes.iconsbar}>Login</Typography>
                </Link>
                <Link className={classes.linkDecoration} to="/signup">
                  <Typography className={classes.iconsbar}>Signup</Typography>
                </Link>
              </div>
            )}
          </Toolbar>
            ...
            <Grid container xs={12}>
              ...
              <Grid container xs={4}>
                ...
                >
                  {authenticated ? (
                    <span>
                      <Typography className={classes.iconsbar}>
                        {username}
                      </Typography>
                      <Typography
                        className={classes.iconsbar}
                    ...
                    <div style={{ display: "flex" }}>
                      <Link className={classes.linkDecoration} to="/login">
                        <Typography variant="h7" className={classes.iconsbar}>
                          Login
                        </Typography>
                      </Link>
                      <Link className={classes.linkDecoration} to="/signup">
