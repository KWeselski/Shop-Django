          ...
          >
            <Link className={classes.linkItem} to={"/"}>
              ...
              >
                <ListItemText
                  disableTypography
                  primary={<Typography variant="h9">All</Typography>}
                />
              </ListItem>
            </Link>
            <Link className={classes.linkItem} to={`/type/${discountType}`}>
              ...
              >
                <ListItemText
                  disableTypography
                  primary={
                    <Typography style={{ color: "red" }} variant="h9">
                      On Discount
                    </Typography>
                  }
                />
                ...
                >
                  ...
                  >
                    <ListItemText
                      disableTypography
                      primary={
                        <Typography style={{ color: "#212121" }} variant="h9">
                          {value.name}
                        </Typography>
                      }
                    />
