...
class PaymentForm extends Component {
  ...
  handleChange = (event) => {
    {event.error ? this.setState({ error: event.error.message }):  this.setState({ error: null })};
  };
            ...
            <Grid item xs={12} md={6}>
              <List>
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h7">
                      Street address: <b>{address.street_address}</b>{" "}
                    </Typography>
                  }
                />
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h7">
                      Apartament address: <b>{address.apartment_address}</b>
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h7">
                      Delivery type: <b>{address.delivery_type}</b>
                    </Typography>
                  }
                />
              </List>
                      ...
                      <ListItemText
                        ...
                        primary={
                          <Typography variant="h9">
                            {value.quantity} x <b>{value.name}</b>
                          </Typography>
                        }
                      />
                    </ListItem>
